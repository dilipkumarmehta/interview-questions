 ...
 * java.util.List;
 * 
 * public class HttpClientExmaple { public static void main(String[] args)
 ...
 * headers, and body
 * 
 * //HttpRequest// HttpRequest request2 = HttpRequest.newBuilder().uri(new
 * URI("https://api.example.com/resource"))
 * .headers(headers).POST(HttpRequest.BodyPublishers.ofString(requestBody)).
 * build(); HttpResponse<String> send2 = client.send(request2,
 * HttpResponse.BodyHandlers.ofString());
 * 
 * 
 * // Query parameters Map<String, String> params = Map.of("param1", "value1",
 * "param2", "value2","param3", "value1", "param4", "value2");
 * 
 * // Construct query string String queryString = params.entrySet().stream()
